...
public class RejectSearchRegexFieldRuleTest extends UnitTestBase {
        ...
        void testThatRuleRejectsSearchMatchingRegex() {
                ...
                assertThat(result)
                                ...
                                .matches(r -> r.getGovernanceRuleResponse().status()
                                                .code() == HttpResponseStatus.BAD_REQUEST.code())
                                .matches(r -> r.getGovernanceRuleResponse().status().reasonPhrase()
