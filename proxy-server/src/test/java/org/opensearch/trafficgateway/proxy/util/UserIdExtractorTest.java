...
public class UserIdExtractorTest extends UnitTestBase {
        ...
        void testThatGetUserIdFromSAMLXMLGetsUserId()
                ...
                // given
                byte[] samlXmlBytes = this.getClass().getResourceAsStream(VALID_XML_RESOURCE_PATH).readAllBytes();
